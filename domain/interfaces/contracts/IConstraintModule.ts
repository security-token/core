...
export type ContractContext = EthersContractContextV5<
  IConstraintModule,
  IConstraintModuleMethodNames,
  IConstraintModuleEventsContext,
  IConstraintModuleEvents
>;
...
export type IConstraintModuleEvents = undefined;
export interface IConstraintModuleEventsContext {}
export type IConstraintModuleMethodNames = 'executeTransfer' | 'getModuleName';
