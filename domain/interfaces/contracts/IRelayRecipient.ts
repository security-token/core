...
export type ContractContext = EthersContractContextV5<
  IRelayRecipient,
  IRelayRecipientMethodNames,
  IRelayRecipientEventsContext,
  IRelayRecipientEvents
>;
...
export type IRelayRecipientEvents = undefined;
export interface IRelayRecipientEventsContext {}
export type IRelayRecipientMethodNames =
  | 'getHubAddr'
  | 'acceptRelayedCall'
  | 'preRelayedCall'
  | 'postRelayedCall';
...
export interface IRelayRecipient {
  /**
   * Payable: false
   * Constant: true
