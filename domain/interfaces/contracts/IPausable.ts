...
export type ContractContext = EthersContractContextV5<
  IPausable,
  IPausableMethodNames,
  IPausableEventsContext,
  IPausableEvents
>;
...
export type IPausableEvents = 'Paused' | 'Unpaused';
export interface IPausableEventsContext {
  Paused(...parameters: any): EventFilter;
  Unpaused(...parameters: any): EventFilter;
}
export type IPausableMethodNames = undefined;
