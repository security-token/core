...
type SecurityToken_Metadata struct {
	...
	BgImage     string `protobuf:"bytes,2,opt,name=bgImage,proto3" json:"bgImage,omitempty"`
...
func (x *SecurityToken_Metadata) GetIcon() string {
	if x != nil {
		return x.Icon
	}
	return ""
...
func (x *SecurityToken_Metadata) GetBgImage() string {
	if x != nil {
		return x.BgImage
	}
	return ""
...
func (x *SecurityToken_Metadata) GetDescription() string {
	if x != nil {
...
var file_schema_token_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xc2, 0x02, 0x0a, 0x0d,
	...
	0x64, 0x61, 0x74, 0x61, 0x1a, 0x5a, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x69, 0x63, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x67, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x18,
